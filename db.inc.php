...
class Db{
    ...
    public function getTerrains($where=[]){
        try{
            $stmt = $this->iPdo->prepare("SELECT tId as Nr, Ter.clubId, Name, Ter.sId, Ter.address, sport, description, latitude, longitude
            ...
            if(is_array($where)){  // si il y a des parametres
                switch (key($where)){
                    // selection d'un club
                    case('club'):$stmt = $this->iPdo->prepare("SELECT tId as Nr, Ter.clubId, Name, Ter.sId, Ter.address, sport, description, latitude, longitude
                                                        FROM integration.tbTerrains as Ter
                                                        join integration.tbSport as Sp ON Ter.sId = Sp.sId
                                                        join integration.tbClub as Cl on Ter.clubId = Cl.clubId
                                                        WHERE Cl.Name = :club;");
                    ...
                    case('sport'):$stmt = $this->iPdo->prepare("SELECT tId as Nr, Ter.clubId, Name, Ter.sId, Ter.address, sport, description, latitude, longitude
                                                        FROM integration.tbTerrains as Ter
                                                        join integration.tbSport as Sp ON Ter.sId = Sp.sId
                                                        join integration.tbClub as Cl on Ter.clubId = Cl.clubId
                    ...
                    case('address'):$stmt = $this->iPdo->prepare("SELECT tId as Nr, Ter.clubId, Name, Ter.sId, Ter.address, sport, description, latitude, longitude
                                                        FROM integration.tbTerrains as Ter
                                                        join integration.tbSport as Sp ON Ter.sId = Sp.sId
                                                        join integration.tbClub as Cl on Ter.clubId = Cl.clubId
                    ...
                    case('zip'):$stmt = $this->iPdo->prepare("SELECT tId as Nr, Ter.clubId, Name, Ter.sId, Ter.address, sport, description, latitude, longitude, ville
                                                        FROM integration.tbTerrains as Ter
                                                        join integration.tbSport as Sp ON Ter.sId = Sp.sId
                                                        join integration.tbClub as Cl on Ter.clubId = Cl.clubId
                    ...
                    case('spec'):$stmt = $this->iPdo->prepare("SELECT tId as Nr, Ter.clubId, Name, Ter.sId, Ter.address, sport, description, latitude, longitude
                                                        FROM integration.tbTerrains as Ter
                                                        join integration.tbSport as Sp ON Ter.sId = Sp.sId
                                                        join integration.tbClub as Cl on Ter.clubId = Cl.clubId
                    ...
                    case('notId'):$stmt = $this->iPdo->prepare("SELECT tId as Nr, Ter.clubId, Name, Ter.sId, Ter.address, sport, description, latitude, longitude
                                                        FROM integration.tbTerrains as Ter
                                                        join integration.tbSport as Sp ON Ter.sId = Sp.sId
                                                        join integration.tbClub as Cl on Ter.clubId = Cl.clubId
                                                        WHERE tid not in (:id);");
    ...
    public function getClubs($id){
        try{
            $stmt = $this->iPdo->prepare("select Name, Address as Adresse, Mail, Téléphone, Ville from tbClub
