			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1><a href="index.php">Sport Share</a></h1>
						<nav id="nav">
							<ul>
								<li class="special">
					...
					<section id="banner">
						<div id="home" class="inner">
							...
							<ul class="actions special">
								<li><a href="signup.php" class="button primary">S'inscrire</a></li>
							</ul>
							<ul class="actions special">
								<li><a href="login.php" class="button primary">Se connecter</a></li>
							</ul>
						</div>
				...
				<!-- Footer -->
					<footer id="footer">
						...
						<ul class="copyright">
							<li>&copy; Sport Share</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
						</ul>
					</footer>
